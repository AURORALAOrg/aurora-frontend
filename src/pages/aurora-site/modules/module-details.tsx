...
const ModuleDetails: React.FC = () => {
  ...
  const imageUrl =
    searchParams.get("imageUrl") || "/assets/certification_banner.png";

  const moduleDetails: ModuleDetailsData = {
    title: title,
    subtitle: description,
    chapters: [
      {
        title: "Chapter 1: Introduction to Software Architecture",
        description: "Lorem Ipsum dolor sit ammet ister ejec",
      },
      {
        title: "Chapter 2: Introduction to Software Architecture",
        description: "Lorem Ipsum dolor sit ammet ister ejec",
      },
      {
        title: "Chapter 3: Introduction to Software Architecture",
        description: "Lorem Ipsum dolor sit ammet ister ejec",
      },
      {
        title: "Chapter 4: Introduction to Software Architecture",
        description: "Lorem Ipsum dolor sit ammet ister ejec",
      },
    ],
  };
  ...
  return (
    <div className="flex w-screen min-h-screen bg-gray-100">
      <main className="flex-1 bg-white p-6">
        ...
        <Card className="w-[85%] bg-gray-50 p-6 rounded-xl shadow-md">
