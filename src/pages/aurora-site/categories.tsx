...
const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  return (
    <Card
      className={`${color} rounded-xl overflow-hidden h-48 transition-transform hover:scale-105 cursor-pointer relative`}
    >
